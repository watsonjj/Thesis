...
\begin{figure}
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{$Q_\text{Exp} = \SI[separate-uncertainty = true]{25.91 \pm 2.06}{\pe}$}
    \label{fig:before_after_ff_25pe}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{before_after_ff_100pe}
    \caption{$Q_\text{Exp} = \SI[separate-uncertainty = true]{95.44 \pm 7.59}{\pe}$}
    \label{fig:before_after_ff_100pe}
  \end{subfigure}
  \caption[Flat-field residuals at other illuminations.]{Same as Figure~\ref{fig:before_after_ff_50pe}, but with a higher and lower expected charge ($Q_\text{Exp}$).}
\end{figure}
