...
\item The \gls{astri} design features a dual-mirror Schwarzschild-Couder telescope structure. \gls{astri} is predominantly developed by Italy, however contributions from \gls{astri} is also 


\gls{astri}Brazil, Italy and South Africa (ASTRI)
\end{itemize}
