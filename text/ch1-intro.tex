...
\end{description}
The interplay between these two processes, occurring after each transversal of a radiation length, produces the extensive cascade of energetic electromagnetic particles illustrated in Figure~\ref{}. The charged particles produced by the pair production in this cascade are responsible for the generation of the Cherenkov light. This cascade is often known as a ``Cherenkov shower''.



At energies above \SI{10}{eV}, the dominating interaction for photons is pair production. The resulting electron-positron 


radiation processes are 


it is possible to perform astronomy via the secondary 



extensive cascade of energetic electromagnetic particles is produced by the interaction of the gamma ray with the atmosphere. The products of this cascade, electrons and positrons, are often superluminal, thereby emitting
Cherenkov radiation. 

the primary mode of interaction with the atmosphere for high energy photons of \SI{\ge 10}{GeV} is pair-production, resulting an electron-position pair which share the total energy and trajectory of the progenitor gamma ray (conserving energy and momentum). The proceeding interplay between pair-production and bremsstrahlung interactions of the secondary products and the atmospheric particles results in an extensive cascade of energetic electromagnetic particles \cite{Weekes2003}. As the 
