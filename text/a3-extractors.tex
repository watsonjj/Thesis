...
\begin{figure}
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{camp1nsb5}
    \caption{1~p.e. illumination, 5~MHz noise.}
    \label{fig:camp1nsb5}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{camp1nsb125}
    \caption{1~p.e. illumination, 125~MHz noise.}
    \label{fig:camp1nsb125}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{camp50nsb5}
    \caption{50~p.e. illumination, 5~MHz noise.}
    \label{fig:camp50nsb5}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.49\textwidth}
    \includegraphics[width=\textwidth]{camp50nsb125}
    \caption{50~p.e. illumination, 125~MHz noise.}
