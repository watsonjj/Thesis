...
\notes[inline,caption={}]{
	...
	\begin{itemize}
		...
		\item \textit{Charge Resolution} of different methods with different NSB (including full integration method)
...
\begin{figure}
  \includegraphics[width=\textwidth]{cr_8_ce_comparison_lab}
...
\begin{figure}
  \includegraphics[width=\textwidth]{cr_8_ce_comparison_opct40}
...
\begin{figure}
  \includegraphics[width=\textwidth]{cr_8_ce_comparison_opct20}
...
\begin{figure}
  \includegraphics[width=\textwidth]{cr_8_ce_comparison_high_noise}
