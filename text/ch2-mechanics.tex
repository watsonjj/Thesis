...
\begin{enumerate}
\item The camera pixels are split into square groups of 4 neighbouring pixels. These are hereafter referred to as a superpixel \final{check other usages of superpixel}. \gls{chec} therefore has 512 superpixels.
