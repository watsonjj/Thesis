...
\change{can I add graphs from reference sheet?}
...
\begin{figure}
	...
	\caption[Image of the MAPMT and FEE for CHEC-M.]{Image of the MAPMT and FEE for CHEC-M with the components labelled \cite{Zorn2017}.}
