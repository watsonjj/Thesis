...
\item Cheap, allowing large arrays of them to be combined to fill the full plate scale and, provide high spatial resolution of the shower.
\end{enumerate}
...
\begin{figure}
	...
	\caption{Common diagram of a Photomultiplier Tube \cite{HAMAMATSU2007}.}
	\label{fig:pmt}
\end{figure}
