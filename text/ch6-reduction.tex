...
\begin{figure}
	\centering
    %\includegraphics[width=\textwidth]{hillas2} 
	\caption[Second Hillas Parametrisation Schematic.]{A useful depiction of the light produced by air showers, and the different image ellipse produced depending on shower direction with respect to the telescope pointing direction \cite{Lessard2001}. \change[inline]{possibly don't need this figure, or move to introduction. Could recreate own version of it}}
	\label{fig:hillas2}
\end{figure}
