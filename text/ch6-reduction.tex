...
The differences in image morphology between gamma-ray and hadronic showers is described in Chapter~\ref{ch1-intro}\otherch{describe differences in images in intro, and show perfect examples with MC of CHECS. Lessard gives precise information about the differences}. These differences are quantified and encapsulated by the \textit{Hillas Parameters}, where gamma-ray showers exist within a narrow range of the parameters, while hadronic showers typically exhibit a broader spectrum of parameter values, as illustrated in Figure~\ref{fig:gamma_hadron_discrimination}. By creating an acceptance range for the \textit{Hillas Parameters}, the hadronic background can be excluded in a very simple way \cite{Dickinson2010,Fegan1999a,Hillas1996a}.
