...
\newglossaryentry{fwhm}{name={FWHM}, description={The full width of a pulse (or distribution) at half of its maximum.}}
...
\newacronym{gapd}{G-APD}{Geiger-mode Avalanche PhotoDiode}
\newacronym{dacq}{DACQ}{Data-Acquisition}
...
\newglossaryentry{target5}{name={TARGET-5}, description={Version 5 of the TARGET ASIC.}}
\newglossaryentry{targetc}{name={TARGET-C}, description={Version C of the TARGET ASIC.}}
\newglossaryentry{t5tea}{name={T5TEA}, description={ASIC chip used alongside TARGET-C for the trigger handling.}}
\newglossaryentry{superpixel}{name={Superpixel}, description={Group of four neighbouring pixels used for triggering (see Section~\ref{section:triggering}).}}
...
\newglossaryentry{vped}{name={Vped}, description={Reference pedestal voltage input into the TARGET ASIC to provide a modest amount of common-mode noise rejection.}}
...
\newglossaryentry{tio}{name={TIO}, description={Custom FITS file format defined by TargetIO used for storing waveform data from TARGET-based cameras.}}
...
\newglossaryentry{hawc}{type=\acronymtype, 
	name={HAWC}, 
	description={High-Altitude Water Cherenkov}, 
	first={HAWC (High-Altitude Water Cherenkov)}
}
...
\newglossaryentry{chec-m}{name={CHEC-M}, description={CHEC utilising MAPMTs as the photosensor.}}
\newglossaryentry{chec-s}{name={CHEC-S}, description={CHEC utilising SiPMs as the photosensor.}}
\newglossaryentry{fact}{type=\acronymtype, 
	name={FACT}, 
	description={First G-APD Cherenkov Telescope}, 
	first={FACT (First G-APD Cherenkov Telescope)}
}
